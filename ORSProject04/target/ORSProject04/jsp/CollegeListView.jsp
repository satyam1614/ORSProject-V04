		...
		<form action="<%=ORSView.COLLEGE_LIST_CTL%>" method="POST">
			...
			<div
				...
				<button type="submit" name="operation"
					...
					onclick="return confirm('Delete selected colleges?')">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="CollegeCtl?id=<%=bean.getId()%>"
								...
								href="<%=ORSView.COLLEGE_LIST_CTL%>?id=<%=bean.getId()%>&operation=<%=BaseCtl.OP_DELETE%>"
								class="btn btn-sm btn-outline-danger"
								onclick="return confirm('Delete this college?')"> <i
