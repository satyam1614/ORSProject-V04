<%@page import="com.sunilos.p4.ctl.LabTestCtl"%>
...
<jsp:useBean id="bean" class="com.sunilos.p4.bean.LabTestBean"
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div class="card-header text-white border-0 py-3 px-4"
			...
			<h5 class="mb-0 fw-bold">
				...
				<%=bean.getId() > 0 ? "Edit LabTest" : "Add LabTest"%>
			</h5>
		</div>
		...
		<div class="card-body px-4 py-4">
			...
			<form action="<%=ORSView.LABTEST_CTL%>" method="POST">
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">Cost <span
						class="text  -danger">*</span></label> <input type="text"
						name="cost" class="form-control" maxlength="200"
						value="<%=DataUtility.getStringData(bean.getCost())%>">
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("cost", request)%></div>
				</div>
				
				<div class="mb-3">
					<label class="form-label fw-semibold">TestDate <span
						class="text-danger">*</span></label> <input type="text" name="testDate"
						id="udatee" readonly="readonly" class="form-control"
						maxlength="200"
						value="<%=DataUtility.getDateString(bean.getTestDate())%>">
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("testDate", request)%></div>
				</div>
				...
				<div class="d-flex gap-2 pt-2 border-top">
					<button type="submit" name="operation" value="<%=BaseCtl.OP_SAVE%>"
					 ...
					 <a href="<%=ORSView.LABTEST_CTL%>" class="btn btn-danger ms-auto">
