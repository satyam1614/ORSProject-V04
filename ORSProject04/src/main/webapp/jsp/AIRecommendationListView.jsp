	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div
			...
			<h5 class="mb-0 fw-bold">
				<i class="bi bi-anthropic me-2"></i>
				AI Recommendation List
			</h5>
			<div class="d-flex gap-2">
				<a href="<%=ORSView.AIRECOMMENDATION_REPORT_CTL%>" target="_blank"
					class="btn btn-sm btn-warning fw-semibold"> <i
					class="bi bi-file-earmark-pdf me-1"></i> Print PDF
				</a> <a href="<%=ORSView.AIRECOMMENDATION_REPORT_CTL%>?type=doc"
					target="_blank" class="btn btn-sm btn-info fw-semibold"> <i
					class="bi bi-file-earmark-word me-1"></i> Print DOC
				</a> <a href="<%=ORSView.AIRECOMMENDATION_CTL%>"
					class="btn btn-sm btn-light text-primary fw-semibold"> <i
					class="bi bi-anthropic me-1"></i> Add AI Recommendation
				</a>
			</div>
		</div>

		<form action="<%=ORSView.AIRECOMMENDATION_LIST_CTL%>" method="POST">
				...
				<table class="table table-hover align-middle mb-0">
					<thead class="table-dark">
						<tr>
							...
							<th><%=ms.get("airecommendation.s.no.")%></th>
							<th>Code</th>
							<th>User Name</th>
							<th>Type</th>
							<th>Status</th>
