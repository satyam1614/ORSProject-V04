<%@page import="com.sunilos.p4.ctl.MobileCtl"%>
<%@page import="com.sunilos.p4.ctl.BaseCtl"%>
<%@page import="com.sunilos.p4.ctl.ORSView"%>
<%@page import="com.sunilos.p4.util.DataUtility"%>
<%@page import="com.sunilos.p4.util.ServletUtility"%>
<%@page import="java.util.List"%>
<%@page import="com.sunilos.p4.bean.MobileBean"%>

<jsp:useBean id="bean" class="com.sunilos.p4.bean.MobileBean"
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div class="card-header text-white border-0 py-3 px-4"
			...
			<h5 class="mb-0 fw-bold">
				...
				<%=bean.getId() > 0 ? "Edit MOBILE" : "Add MOBILE"%>
			</h5>
		</div>
		...
		<div class="card-body px-4 py-4">
			...
			<form action="<%=ORSView.MOBILE_CTL%>" method="POST">
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">Mobile Number <span
						...
						name="mobileNumber" class="form-control" maxlength="200"
						value="<%=DataUtility.getStringData(bean.getMobileNumber())%>">
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("mobileNumber", request)%></div>
				</div>

				<div class="mb-3">
					<label class="form-label fw-semibold">Otp <span
						class="text-danger">*</span></label> <input type="text" name="otp" class="form-control"
						maxlength="200"
						value="<%=DataUtility.getStringData(bean.getOtp())%>">
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("otp", request)%></div>
				</div>
          ...
          <a href="<%=ORSView.MOBILE_CTL%>" class="btn btn-danger ms-auto">
