	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div
			...
			<div class="d-flex gap-2">
				<a href="<%=ORSView.MOBILE_REPORT_CTL %>" target="_blank"
					class="btn btn-sm btn-warning fw-semibold"> <i
					class="bi bi-file-earmark-pdf me-1"></i> Print PDF
				</a> <a href="<%=ORSView.MOBILE_REPORT_CTL%>?type=doc" target="_blank"
				...
				<table class="table table-hover align-middle mb-0">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="MobileCtl?id=<%=bean.getId()%>"
