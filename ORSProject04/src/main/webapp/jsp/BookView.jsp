<%@page import="com.sunilos.p4.ctl.BookCtl"%>
...
<jsp:useBean id="bean" class="com.sunilos.p4.bean.BookBean"
			...
			<form action="<%=ORSView.BOOK_CTL%>" method="POST">
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">Author <span
						...
						name="author" class="form-control" maxlength="200"
						value="<%=DataUtility.getStringData(bean.getAuthor())%>">
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("author", request)%></div>
				</div>

				<div class="mb-3">
					<label class="form-label fw-semibold">Price <span
						class="text-danger">*</span></label> <input type="text" name="price" class="form-control"
						maxlength="200"
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">Publisher <span
						class="text-danger">*</span></label> <input type="text" name="publisher"
						class="form-control" maxlength="200"
						value="<%=DataUtility.getStringData(bean.getPublisher())%>">
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("publisher", request)%></div>
				</div>
