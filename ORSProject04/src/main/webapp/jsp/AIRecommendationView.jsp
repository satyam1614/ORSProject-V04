...
<%@page import="com.sunilos.p4.ctl.AIRecommendationCtl"%>
...
<jsp:useBean id="bean" class="com.sunilos.p4.bean.AIRecommendationBean"
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div class="card-header text-white border-0 py-3 px-4"
			...
			<h5 class="mb-0 fw-bold">
				<i class="bi bi-openai me-2"></i>
				<%=bean.getId() > 0 ? "Edit AI Recommendation" : "Add AI Recommendation"%>
			</h5>
		</div>
		...
		<div class="card-body px-4 py-4">
			...
			<form action="<%=ORSView.AIRECOMMENDATION_CTL%>" method="POST">
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">Code<span
						...
						placeholder="enter code" class="form-control" maxlength="100"
				...
				<div class="d-flex gap-2 pt-2 border-top">
					...
					<a href="<%=ORSView.AIRECOMMENDATION_CTL%>"
						class="btn btn-danger ms-auto"> <i class="bi bi-x-circle me-1"></i>
